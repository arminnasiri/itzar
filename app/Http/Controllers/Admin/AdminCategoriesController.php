...
class AdminCategoriesController extends Controller
{
	...
	public function categories(){
		...
		->where('parent_id', '0')->where('language_id','=',1 )->paginate(10);
	...
	public function subcategories(){
		...
		->where('subCategories.parent_id', '>', '0')->where('subCategoryDesc.language_id','=',1 )->paginate(20);
		//dd($listingSubCategories);
