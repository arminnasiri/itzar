...
Route::group(['prefix' => 'admin'], function () {
	...
	Route::group(['namespace' => 'Admin'], function () {
		...
		*/
            ...
            Route::get('/partcategories', 'AdminPartCategoriesController@categories');
            Route::get('/addpartcategory', 'AdminPartCategoriesController@addcategory');
            Route::post('/addnewpartcategory', 'AdminPartCategoriesController@addnewcategory');
            Route::get('/editpartcategory/{id}', 'AdminPartCategoriesController@editcategory');
            Route::post('/updatepartcategory', 'AdminPartCategoriesController@updatecategory');
            Route::get('/deletepartcategory/{id}', 'AdminPartCategoriesController@deletecategory');
			//sub part categories
			Route::get('/subpartcategories', 'AdminPartCategoriesController@subcategories');
			Route::get('/addsubpartcategory', 'AdminPartCategoriesController@addsubcategory');
			Route::post('/addnewsubpartcategory', 'AdminPartCategoriesController@addnewsubcategory');
			Route::get('/editsubpartcategory/{id}', 'AdminPartCategoriesController@editsubcategory');
			Route::post('/updatesubpartcategory', 'AdminPartCategoriesController@updatesubcategory');
			Route::get('/deletesubpartcategory/{id}', 'AdminPartCategoriesController@deletesubcategory');
            //sub  categories
			...
			Route::post('/addnewcustomers', 'AdminCustomersController@addnewcustomers');
             // customer_group
            Route::get('/customer_groups', 'Admin_Group_Customer@customer_groups');
            Route::get('/add_customer_group', 'Admin_Group_Customer@add_customer_groups');
            Route::post('/add_customer_group', 'Admin_Group_Customer@story_customer_group');
            Route::get('/customer_group/{id}', 'Admin_Group_Customer@edit_customer_group');
            Route::post('/update_customer_group', 'Admin_Group_Customer@update_customer_group');
            Route::get('/delete_customer_group/{id}', 'Admin_Group_Customer@delete_customer_group');
			...
			//part
            Route::get('/parts', 'AdminPartController@parts');
            Route::get('/addpart', 'AdminPartController@addpart');
            Route::post('/addnewpart', 'AdminPartController@addnewpart');
            Route::get('/editpart/{id}', 'AdminPartController@editpart');
            Route::post('/updatepart', 'AdminPartController@updatepart');
            Route::get('/deletepart/{id}', 'AdminPartController@deletepart');
            Route::post('/getsubpart/', 'AdminPartController@getsubpartcategory');
            Route::post('/getpart/', 'AdminPartController@getpart');
            Route::get('/api/part/{id}',function ($id){
                 return DB::table('part')->where('id_part_sub_category',$id)->paginate(10);
            });
            //PriceBoard

            Route::get('/price_board/', 'AdminPriceBoardController@index');
            Route::post('/price_board/', 'AdminPriceBoardController@update');
