                           ...
                           <form>
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-10 col-md-4">
                                        <input type="text"  class="form-control field-validate" value="">
                                       <!-- <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.CategoryName') }} .</span>           -->
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    <input type="hidden" name="old_slug" value="">
                                    <input type="text" name="slug" class="form-control field-validate" value="">
                              ...
                              <div class="box-footer text-center">
                                ...
                                <a href="{{ URL::to('admin/pcollection')}}" type="button" class="btn btn-default">{{ trans('labels.back') }}</a>
                              </div>
                              <!-- /.box-footer -->
                            {!! Form::close() !!}
                        </div>
