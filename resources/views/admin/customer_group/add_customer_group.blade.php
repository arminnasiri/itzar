              		...
              		<div class="box box-info">
                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                            ...
                            {!! Form::open(array('url' =>'admin/add_customer_group', 'method'=>'post', 'class' => 'form-horizontal form-validate')) !!}

                             <div class="form-group">
                                 <label for="is_teammate" class="col-sm-2 col-md-3 control-label">{{ trans('labels.co_worker') }}</label>
                                 <div class="col-sm-10 col-md-4">
                                     <input type="checkbox" name="is_teammate" >
                                 </div>
                             </div>
                              @foreach($result['languages'] as $languages)
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    <input type="text" name="customer_group_title_{{$languages->languages_id}}" class="form-control field-validate">
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="col-sm-10 col-md-4">
                                     <input type="text" name="customer_group_profit" class="form-control field-validate">
                                     <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.profit') }}</span>
                                     <span class="help-block hidden">{{ trans('labels.textRequiredFieldMessage') }}</span>
                                 </div>
                             </div>
                             <div class="form-group">
                                 <label for="customer_group_tax" class="col-sm-2 col-md-3 control-label">{{ trans('labels.tax') }}</label>
                                 <div class="col-sm-10 col-md-4">
                                     <input type="text" name="customer_group_tax" class="form-control field-validate">
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="col-sm-10 col-md-4">
                                     <input type="radio" name="payment"  id="_all" value="all"> {{ trans('labels.all') }}<br>
                                     <input type="radio" name="payment" id="_non" value="non"> {{ trans('labels.non') }}<br>
                                     <input type="radio" name="payment" id="_non_metallic" value="non_metallic"> {{ trans('labels.non_metallic') }}<br>
                                     <input type="radio" name="payment" id="_gold" value="gold"> {{ trans('labels.gold') }}<br>
                                     <input type="radio" name="payment" id="_silver" value="silver"> {{ trans('labels.silver') }}<br>
                                     <input type="radio" name="payment"  id="_titanium" value="titanium"> {{ trans('labels.titanium') }}<br>
                                     <input type="radio" name="payment" id="_iron" value="iron"> {{ trans('labels.iron') }}<br>
                                 </div>
                             </div>
                              <!-- /.box-body -->
