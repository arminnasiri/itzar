        ...
        <div class="box">
          <div class="box-header">
            ...
            <div class="box-tools pull-right">
            	<a href="{{ URL::to('admin/addsubpartcategory')}}" type="button" class="btn btn-block btn-primary">{{ trans('labels.AddSubPartCategory') }}</a>
            </div>
          </div>
                   ...
                   @if(count($listingSubCategories)>0)
                    ...
                    @if($categories->language_id == '1')
                        <tr>
                            ...
                            <td>
                                <a data-toggle="tooltip" data-placement="bottom" title="Edit" href="editsubpartcategory/{{ $categories->subId }}" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                <a data-toggle="tooltip" data-placement="bottom" title="Delete" href="deletesubpartcategory/{{ $categories->subId }}" class="badge bg-red"><i class="fa fa-trash" aria-hidden="true"></i></a>
                            </td>
                        </tr>
                        @endif
                    @endforeach
