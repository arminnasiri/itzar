                                 ...
                                 <div class="col-sm-10 col-md-4">
                                     <select class="form-control" name="id_group">
                                         @foreach($data['customer_group'] as $customer_group)
                                             @if($data['customers'][0]->customers_group_id==$customer_group->customers_group_id)
                                                 <option value="{{$customer_group->customers_group_id}}" selected>{{ $customer_group->customers_group_title}}</option>
                                             @else
