                            ...
                            {!! Form::open(array('url' =>'admin/updatemanufacturer', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                ...
                                <div class="form-group">
                                  <div class="col-sm-10 col-md-4">
                                    ...
                                    <input type="hidden" name="slug" class="form-control field-validate" value="{{$editManufacturer[0]->slug}}">
                                  </div>
                                </div>
                             ...
                             <div class="form-group">
                                 <label for="m_name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.FirstName').' '.trans('labels.LastName') }}</label>
                                 <div class="col-sm-10 col-md-4">
                                     {!! Form::text('m_name',  $editManufacturer[0]->m_name , array('class'=>'form-control', 'id'=>'m_name')) !!}
                                     <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.FirstName').' '.trans('labels.LastName') }}</span>
                                 </div>
                             </div>
                             <div class="form-group">
                                 <label for="uid" class="col-sm-2 col-md-3 control-label">{{ trans('labels.ID')}}</label>
                                 <div class="col-sm-10 col-md-4">
                                     {!! Form::text('uid',  $editManufacturer[0]->uid , array('class'=>'form-control', 'id'=>'uid')) !!}
                                     <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.ID')}}</span>
                                 </div>
                             </div>
                             <div class="form-group">
                                 <label for="mobile" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Phone')}}</label>
                                 <div class="col-sm-10 col-md-4">
                                     {!! Form::number('mobile',  $editManufacturer[0]->mobile , array('class'=>'form-control', 'id'=>'mobile')) !!}
                                     <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.Phone')}}</span>
                                 </div>
                             </div>
                             <div class="form-group">
                                 <label for="email" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Email')}}</label>
                                 <div class="col-sm-10 col-md-4">
                                     {!! Form::text('email',  $editManufacturer[0]->email , array('class'=>'form-control', 'id'=>'email')) !!}
                                     <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.Email')}}</span>
                                 </div>
                             </div>
                                <div class="form-group">
