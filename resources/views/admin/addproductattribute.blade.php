					...
					<div class="modal-content">
					  ...
					  <div class="modal-body">
                          ...
                          <div class="form-group">
                              <label for="name" class="col-sm-2 col-md-4 control-label">{{ trans('labels.OptionValues') }}</label>
                              <div class="col-sm-10 col-md-8">
                                  <select class="form-control product_attr_mode field-validate" name="product_attr_mode">
                                      <option value="0">اجرت</option>
                                      <option value="1">کسر ساخت</option>
                  ...
                  <thead>
                    <tr>
                      ...
                      <th>{{ trans('labels.Price') }}</th>
                        <th>{{ trans('labels.EffectiveProduct') }}</th>
                      <th>{{ trans('labels.Action') }}</th>
                  		...
                  		@if (count($result['products_attributes']) > 0)
							@foreach($result['products_attributes'] as $key=>$products_attributes)
                                ...
                                <tr>
                                    ...
                                    <td>{{ $products_attributes->options_values_name }}</td>
                                    <td>{{ $products_attributes->price_prefix }}{{ $products_attributes->options_values_price }}</td>
                                    <td>{{$products_attributes->product_attr_mode==0?'اجرت(به تومان می باشد)':$products_attributes->product_attr_mode==1?'کسر ساخت(به درصد)':'وزن(به گرم)'}}</td>
                                    <td>
					...
					<div class="modal-content">
					  ...
					  <div class="modal-body">		
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10 col-md-8">
                                  <select class="form-control product_attr_mode field-validate" name="product_attr_mode">
                                      <option value="0"> اجرت(به تومان می باشد)</option>
                                      <option value="1">کسر ساخت(به درصد)</option>
                                      <option value="2">وزن(به گرم)</option>
                                  </select>
                                  <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                  {{ trans('labels.AddOptionValueText') }}</span>
                              </div>
