                          ...
                          @foreach ($categories as $key=>$category)
                              <tr>
                                  ...
                                  <td><a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Edit') }}" href='editcategory/{{ $category->id }}' class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                      <a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Delete') }}" onclick="sweetAlert('deletecategory/{{ $category->id }}'); return false;" href="#" class="badge bg-red"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                              </tr>
