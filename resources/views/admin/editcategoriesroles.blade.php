                            ...
                            <input type="hidden" name="categories_role_id" value="{{$result['data'][0]->categories_role_id}}">       
                             <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <div class="form-group">
                                  <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Production') }}</label>
                                  <div class="col-sm-10 col-md-4">
                                        <select name="manufacturers[]" class="select2 btn-block" id="example-getting-started" multiple="multiple" >
                                          @foreach ($result['manufacturers'] as $item)                                    
                                            <option value="{{ $item->manufacturers_id }}">{{$item->manufacturers_name}}</option>
                                          @endforeach                                          
                                        </select>                                          
                                      <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                      {{ trans('labels.ChooseCatgoryText') }}.</span>
