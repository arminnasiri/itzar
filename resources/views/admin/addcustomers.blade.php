                         ...
                         <div class="box-body">
                            {!! Form::open(array('url' =>'admin/addnewcustomers', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                             <div class="form-group">
                                 <label for="customer_group" class="col-sm-2 col-md-3 control-label">{{ trans('labels.customer_group') }} </label>
                                 <div class="col-sm-10 col-md-4">
                                     <select class="form-control" name="id_group">
                                        @foreach($customers['customer_group'] as $customer_group)
                                             <option value="{{$customer_group->customers_group_id}}" >{{ $customer_group->customers_group_title}}</option>
                                         @endforeach
                                     </select>
                                     <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                  {{ trans('labels.customer_StatusText') }}</span>
                                 </div>
                             </div>
                             <div class="form-group">
                                 <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.customer_gallery_name') }} </label>
                                 <div class="col-sm-10 col-md-4">
                                     {!! Form::text('customers_gallery_name',  '', array('class'=>'form-control field-validate', 'id'=>'customers_gallery_name')) !!}
                                     <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.customer_gallery_name') }}</span>
