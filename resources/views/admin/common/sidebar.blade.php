<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview {{ Request::is('admin/categories') ? 'active' : '' }} {{ Request::is('admin/addcategory') ? 'active' : '' }} {{ Request::is('admin/editCategory/*') ? 'active' : '' }} {{ Request::is('admin/subcategories') ? 'active' : '' }}  {{ Request::is('admin/addsubcategory') ? 'active' : '' }}  {{ Request::is('admin/editsubcategory/*') ? 'active' : '' }}{{ Request::is('admin/partcategories') ? 'active' : '' }} {{ Request::is('admin/addpartcategory') ? 'active' : '' }} {{ Request::is('admin/editpartCategory/*') ? 'active' : '' }} {{ Request::is('admin/subpartcategories') ? 'active' : '' }}  {{ Request::is('admin/addsubpartcategory') ? 'active' : '' }}  {{ Request::is('admin/editsubpartcategory/*') ? 'active' : '' }}">
          <a href="#">
...
<span>{{ trans('labels.link_categories') }} </span> <i class="fa fa-angle-left pull-right"></i>
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ Request::is('admin/subcategories') ? 'active' : '' }}  {{ Request::is('admin/addsubcategory') ? 'active' : '' }}  {{ Request::is('admin/editsubcategory/*') ? 'active' : '' }}"><a href="{{ URL::to('admin/subcategories')}}"><i class="fa fa-circle-o"></i>{{ trans('labels.link_sub_categories') }}</a></li>
              <li class="{{ Request::is('admin/partcategories') ? 'active' : '' }} {{ Request::is('admin/addpartcategory') ? 'active' : '' }} {{ Request::is('admin/editpartcategory/*') ? 'active' : '' }}"><a href="{{ URL::to('admin/partcategories')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.link_main_categories_part') }}</a></li>
              <li class="{{ Request::is('admin/subpartcategories') ? 'active' : '' }}  {{ Request::is('admin/addsubpartcategory') ? 'active' : '' }}  {{ Request::is('admin/editsubpartcategory/*') ? 'active' : '' }}"><a href="{{ URL::to('admin/subpartcategories')}}"><i class="fa fa-circle-o"></i>{{ trans('labels.link_sub_categories_part') }}</a></li>
          </ul>
        </li>
        @endif
        @if(session('products_view')==1  or auth()->guard('admin')->user()->adminType=='1')
        <li class="treeview {{ Request::is('admin/parts') ? 'active' : '' }} {{ Request::is('admin/products') ? 'active' : '' }} {{ Request::is('admin/addproduct') ? 'active' : '' }} {{ Request::is('admin/editattributes/*') ? 'active' : '' }} {{ Request::is('admin/attributes') ? 'active' : '' }}  {{ Request::is('admin/addattributes') ? 'active' : '' }} {{ Request::is('admin/addproductattribute/*') ? 'active' : '' }} {{ Request::is('admin/addinventory/*') ? 'active' : '' }} {{ Request::is('admin/addproductimages/*') ? 'active' : '' }}  {{ Request::is('admin/pcollection') ? 'active' : '' }}{{ Request::is('admin/pcollectionAdd') ? 'active' : '' }} ">
          <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ Request::is('admin/parts') ? 'active' : '' }}  {{ Request::is('admin/addpart') ? 'active' : '' }}  {{ Request::is('admin/editpart/*') ? 'active' : '' }}" ><a href="{{ URL::to('admin/parts' )}}"><i class="fa fa-circle-o"></i> {{ trans('labels.link_add_part') }}</a></li>
            <li class="{{ Request::is('admin/pcollection') ? 'active' : '' }}{{ Request::is('admin/pcollectionAdd') ? 'active' : '' }}" ><a href="{{ URL::to('admin/pcollection' )}}"><i class="fa fa-circle-o"></i> {{ trans('labels.collections')}}</a></li>
          </ul>
        </li>
         @endif
...
<span>{{ trans('labels.link_news') }}</span> <i class="fa fa-angle-left pull-right"></i>
        ...
        <li class="treeview {{ Request::is('admin/customers') ? 'active' : '' }}  {{ Request::is('admin/addcustomers') ? 'active' : '' }}  {{ Request::is('admin/editcustomers/*') ? 'active' : '' }}{{ Request::is('admin/customer_groups') ? 'active' : '' }}">
          <a href="#">
            <i class="fa fa-users" aria-hidden="true"></i> <span>{{ trans('labels.link_customers') }}</span>
          </a>
            <ul class="treeview-menu">
                <li class="{{ Request::is('admin/newscategories') ? 'active' : '' }} {{ Request::is('admin/addnewscategory') ? 'active' : '' }} {{ Request::is('admin/editnewscategory/*') ? 'active' : '' }}"><a href="{{ URL::to('admin/customers')}}"><i class="fa fa-circle-o"></i>{{ trans('labels.link_sub_customers') }}</a></li>
                <li class="{{ Request::is('admin/customer_groups') ? 'active' : '' }}  {{ Request::is('admin/add_customer_groups') ? 'active' : '' }}  {{ Request::is('admin/edit_customer_groups/*') ? 'active' : '' }}"><a href="{{ URL::to('admin/customer_groups')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.link_customers_categories') }}</a></li>
            </ul>
        </li>
         @endif
...
<span> {{ trans('labels.link_general_settings') }}</span> <i class="fa fa-angle-left pull-right"></i>
        ...
        @if(session('manage_admins_view')==1 or auth()->guard('admin')->user()->adminType=='1')
         ...
         @endif
          @if(session('manage_admins_view')==1 or auth()->guard('admin')->user()->adminType=='1')
              <li class="treeview {{ Request::is('admin/admins') ? 'active' : '' }} {{ Request::is('admin/addadmins') ? 'active' : '' }} {{ Request::is('admin/editadmin/*') ? 'active' : '' }} {{ Request::is('admin/manageroles') ? 'active' : '' }} {{ Request::is('admin/addadminType') ? 'active' : '' }} {{ Request::is('admin/editadminType/*') ? 'active' : '' }}">
                  <a href="{{URL::to('admin/price_board/')}}">
                      <i class="fa fa-list" aria-hidden="true"></i>
                      <span> {{ trans('labels.Bord Price') }}</span> <i class="fa fa-angle-left pull-right"></i>
                  </a>
              </li>
          @endif
      </ul>
