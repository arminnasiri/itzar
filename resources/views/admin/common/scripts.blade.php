...
<script src="{!! asset('resources/views/admin/plugins/sweetAlert/sweet_alert.js') !!}"></script>
...
function sweetAlert(href) {
	swal({
		title: "{{ trans('labels.sweet_alert_title')}}",
		text: "",
		icon: "warning",
		// buttons: true,
		dangerMode: true,
		buttons: [ "{{ trans('labels.No')}}","{{ trans('labels.Yes')}}" ],
