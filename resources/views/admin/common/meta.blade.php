<head>
  ...
  <!-- style changes -->
  <link rel="stylesheet" href="{!! asset('resources/views/admin/plugins/admin.css') !!}">
  ...
  <![endif]-->
  <link href="{!! asset('public/js/multiselect/select2.min.css') !!} " media="all" rel="stylesheet" type="text/css"/>
</head>
