                        ...
                        <article>
                            ...
                            <div class="price">
                                @if(!empty($products->discount_price))
                                    ...
                                    {{$web_setting[19]->value}}{{$products->discount_price+0}} <span>{{$web_setting[19]->value}}{{number_format($products->products_price+0)}}</span>
                                @else
                                    
                                    {{$web_setting[19]->value}}{{number_format($products->products_price+0)}}
                              ...
                              <article>
                                <div class="thumb"> <img class="img-fluid" src="{{asset('').$products->products_image}}" alt="{{$products->products_name}}"> </div>
                                    ...
                                    <div class="price text-center">
                                        @if(!empty($products->discount_price))
                                       {{$products->discount_price+0}}{{$web_setting[19]->value}} <span>{{number_format($products->products_price+0)}}{{$web_setting[19]->value}}</span> @else
                    ...
                    <div class="products products-5x">
                        ...
                        <div class="product">
                          <article>
                            ...
                            <div class="price text-center">
                            {{$special->discount_price+0}}{{$web_setting[19]->value}}<span>{{number_format($special->products_price+0)}}{{$web_setting[19]->value}}</span></div>
                            <div class="product-hover">
