            ...
            <div class="row align-items-center">
                <div class="col-12">
                	...
                	<nav id="navbar_0" class="navbar navbar-expand-md navbar-dark navbar-0 p-0">
                        <div class="navbar-brand navbar-brand--w">
                                    ...
                                    @if($result['commonContent']['recentProducts']['success']==1)
                                        ...
                                        @foreach($result['commonContent']['recentProducts']['product_data'] as $key=>$products)
                                            <div class="carousel-item @if($key==0) active @endif">
                                                ...
                                                {{-- <a href="{{ URL::to('/product-detail/'.$products->products_slug)}}"><img src="http://127.0.0.1/itzar/resources/assets/images/category_images/1502285429.men.jpg" alt="{{$products->products_name}}"></a> --}}
