...
<section class="site-content">
  <div class="container"> 
     <div class="group-banners d-slide">
    	<div class="row">
                ...
                @foreach(($result['commonContent']['homeBanners']) as $homeBanners)                
                    ...
                    <div class="col-12 col-sm-4 ">
                        <div class="banner-image">
                            <a title="Banner Image" href="{{ $homeBanners->banners_url}}"><img class="img-fluid banner-image--w" src="{{asset('').$homeBanners->banners_image}}" alt="Banner Image"></a>
                        </div>
                    </div>
                    @endif                
                @endforeach
    ...
    <div class="products-area d-slide--r">

           <!-- start code -->
       <div class="row">
           <div class="col-md-12">
       <div class="nav nav-pills" role="tablist">
             <a class="nav-link nav-item nav-index active" href="#featured" id="featured-tab" data-toggle="pill" role="tab" aria-controls="featured" aria-selected="true">اسلایدر بالا</a> 
        </div>
            ...
            @endif
                ...
                @if(count($result['commonContent']['homeBanners'])>0)
                    ...
                    @if($homeBanners->type==1)
                        <div class="banner-image">
                            <a title="Banner Image" href="{{$homeBanners->banners_url}}"><img src="{{asset('').$homeBanners->banners_image}}"></a>
                        </div>                        
                    @endif
                ...
                <div class="product" id="product_div_{{$products->products_id}}">
                  <article>
                    ...
                    <div class="price text-center">                     
                    	{{$products->flash_price+0}}{{$web_setting[19]->value}}                   
                ...
                <div class="product">
                  <article>
                       ...
                       <div class="thumb"> <img class="img-fluid" src="{{asset('').$top_seller->products_image}}" alt="{{$top_seller->products_name}}"></div>
                        ...
                        <div class="price text-center">
                        	@if(!empty($top_seller->discount_price))                        
                          	{{$top_seller->discount_price+0}}{{$web_setting[19]->value}}                           
                          	<span>{{number_format($top_seller->products_price+0)}}{{$web_setting[19]->value}}</span>
                          	@else
                          		{{number_format($top_seller->products_price+0)}}{{$web_setting[19]->value}}
                          	@endif 
						</div>
              ...
              <div id="owl_special" class="owl-carousel"> @if($result['special']['success']==1)
                ...
                <div class="product">
                  <article>
                    ...
                    <div class="price text-center">                     
                    	{{$special->discount_price+0}}{{$web_setting[19]->value}}
                    	<span>{{number_format($special->products_price+0)}}{{$web_setting[19]->value}}</span>
                    </div>                   
                    
                    <div class="product-hover">
                    @if($special->products_type!=2)
                        <a  href="{{ URL::to('/product-detail/'.$special->products_slug)}}">
                    @endif    
                     	<div class="icons">
                        	<div class="icon-liked">
                ...
                <div class="product">
                  <article>
				   ...
				   ?>
                    ...
                    <div class="price text-center">
                      @if(!empty($most_liked->discount_price))
                      	{{$most_liked->discount_price+0}}{{$web_setting[19]->value}} <span>{{$most_liked->products_price+0}}{{$web_setting[19]->value}}</span> @else
                      	{{$most_liked->products_price+0}}{{$web_setting[19]->value}}
                      @endif 
                    </div>
