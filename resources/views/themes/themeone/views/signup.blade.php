...
<div class="registration-area">
		...
		<div class="row">
			<div class="col-12 col-md-6 col-lg-2 new-customers"></div>
			<div class="col-12 col-md-6 col-lg-8 new-customers">
				...
				<form name="signup" enctype="multipart/form-data" class="form-validate" action="{{ URL::to('/signupProcess')}}" method="post">
					...
					<div class="form-group row">
						<label for="inputPassword4" class="col-sm-4 col-form-label"><strong>*</strong>@lang('website.Phone')</label>
						<div class="col-sm-8">
							<input type="text" class="form-control password" name="phone" id="phone">
					...
					<div class="button">
                    	<button type="submit" class="btn btn-dark pull-left">@lang('website.Sign Up')</button>
                    </div>
				</form>
			</div>
			<div class="col-12 col-md-6 col-lg-2 new-customers">
