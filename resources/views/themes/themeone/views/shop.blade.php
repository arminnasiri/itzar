    	...
    	<div class="breadcum-area">
            <div class="breadcum-inner">
                ...
                <ol class="breadcrumb">                    
                    ...
                    <!-- <li class="breadcrumb-item dltr"><a href="{{ URL::to('/')}}">@lang('website.Home')</a></li> -->
                    @if(!empty($result['category_name']) and !empty($result['sub_category_name']))
                    	<li class="breadcrumb-item dltr"><a href="{{ URL::to('/shop')}}">@lang('website.Shop')</a></li>
                    	<li class="breadcrumb-item dltr"><a href="{{ URL::to('/shop?category='.$result['category_slug'])}}">{{$result['category_name']}}</a></li>
						<li class="breadcrumb-item dltr active">{{$result['sub_category_name']}}</li>
                    @elseif(!empty($result['category_name']) and empty($result['sub_category_name']))
                    	<li class="breadcrumb-item dltr"><a href="{{ URL::to('/shop')}}">@lang('website.Shop')</a></li>
                    	<li class="breadcrumb-item dltr active">{{$result['category_name']}}</li>
                    @else                    
                    	<li class="breadcrumb-item dltr active">@lang('website.Shop')</li>
                    @endif
                </ol>
            </div>
        </div>
                            ...
                            @endif
                             ...
                             @if($result['products']['total_record']>0)
                                ...
                                <div class="toolbar mt-3">
                                    <div class="form-inline">
                                        <div class="form-group  justify-content-start col-md-6 col-xs-12">
                                        ...
                                        <div class="form-group justify-content-end col-md-6 col-xs-12">
                                            ...
                                            ?>
                                            <button class="btn btn-dark pull-left" type="button" id="load_products" 
